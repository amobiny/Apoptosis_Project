...
# Hyper-parameters
flags.DEFINE_string('loss_type', 'margin', 'cross-entropy, spread or margin')
...
flags.DEFINE_float('percent', 0.05, 'Percentage of training data to use')
...
# Directories
flags.DEFINE_string('run_name', 'run01_0.05', 'Run name')
